...
public class News4Controller implements Initializable{
    ...
    @FXML
    void News41(ActionEvent event) throws Exception{
        Stage stage = (Stage)((Button)event.getSource()).getScene().getWindow();
        stage.setScene(FXMLLoader.load(getClass().getResource("News41.fxml")));
    }
    @FXML
    void News42(ActionEvent event) throws Exception{
        Stage stage = (Stage)((Button)event.getSource()).getScene().getWindow();
        stage.setScene(FXMLLoader.load(getClass().getResource("News42.fxml")));
    }
    @FXML
    void News43(ActionEvent event)throws Exception{
        Stage stage = (Stage)((Button)event.getSource()).getScene().getWindow();
        stage.setScene(FXMLLoader.load(getClass().getResource("News43.fxml")));
    }
}