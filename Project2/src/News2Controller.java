...
public class News2Controller implements Initializable{
    ...
    @FXML
    void News21(ActionEvent event) throws Exception{
        Stage stage = (Stage)((Button)event.getSource()).getScene().getWindow();
        stage.setScene(FXMLLoader.load(getClass().getResource("News21.fxml")));
    }
    @FXML
    void News22(ActionEvent event) throws Exception{
        Stage stage = (Stage)((Button)event.getSource()).getScene().getWindow();
        stage.setScene(FXMLLoader.load(getClass().getResource("News22.fxml")));
    }
    @FXML
    void News23(ActionEvent event)throws Exception{
        Stage stage = (Stage)((Button)event.getSource()).getScene().getWindow();
        stage.setScene(FXMLLoader.load(getClass().getResource("News23.fxml")));
    }
}