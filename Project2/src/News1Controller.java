...
public class News1Controller implements Initializable{
    ...
    @FXML
    void News11(ActionEvent event) throws Exception{
        Stage stage = (Stage)((Button)event.getSource()).getScene().getWindow();
        stage.setScene(FXMLLoader.load(getClass().getResource("News11.fxml")));
    }

    @FXML
    void News12(ActionEvent event) throws Exception{
        Stage stage = (Stage)((Button)event.getSource()).getScene().getWindow();
        stage.setScene(FXMLLoader.load(getClass().getResource("News12.fxml")));
    }

    @FXML
    void News13(ActionEvent event)throws Exception{
        Stage stage = (Stage)((Button)event.getSource()).getScene().getWindow();
        stage.setScene(FXMLLoader.load(getClass().getResource("News13.fxml")));
    }
}
